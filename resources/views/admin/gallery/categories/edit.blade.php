...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item">
                <a href="{{ route('admin.gallery.category.index') }}">Categories</a>
            </div>
            <div class="breadcrumb-item">
                {{ $model->name }}
            </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @if ($errors->any())
                ...
                @endforeach
            @endif
            <form class="form-horizontal" action="{{ route('admin.gallery.category.update', $model->id) }}" method="post">
                {{ method_field('put') }}
                {{ csrf_field() }}
                ...
                <div class="form-actions">
                    <a href="{{ route('admin.gallery.category.index') }}" tabindex="-1" class="btn btn-secondary">
