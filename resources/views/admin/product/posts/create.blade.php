...
<section class="section">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endforeach
            @endif
            <form class="form-horizontal" action="{{ route('admin.product.posts.store') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select class="form-control" id="category" name="product_category_id" required>
                                    <option disabled {{ old('product_category_id') ? '' : 'selected' }}>Please select the category</option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="price" size="16" type="number" name="price" placeholder="Price of product" value="{{ old('price') }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="price" size="16" type="number" name="price_false" placeholder="Price false of product" value="{{ old('price_false') }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="price" size="16" type="text" name="weight" placeholder="Weight of product" value="{{ old('weight') }}" required>
                            </div>
                        </div>
                    </div>
                </div>
