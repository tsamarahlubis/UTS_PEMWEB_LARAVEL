...
<section class="section">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endforeach
            @endif
            <form class="form-horizontal" action="{{ route('admin.product.posts.update', $model->id) }}" method="post" enctype="multipart/form-data" id="form-posts">
                {{ method_field('put') }}
                {{ csrf_field() }}
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="title" size="16" type="text" name="title" placeholder="Title of the product" value="{{ $model->title }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <select class="form-control" id="category" name="product_category_id" required>
                                    <option disabled {{ !$model->product_category_id ? 'selected' : '' }}>Please select the category</option>
                                    @foreach ($categories as $category)
                                    <option value="{{ $category->id }}" {{ ($model->product_category_id == $category->id) ? 'selected' : '' }}>{{ $category->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="price" size="16" type="number" name="price" placeholder="Price of product" value="{{ $model->price }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            <label class="col-form-label" for="price">Price False</label>
                            <div class="controls">
                                <input class="form-control" id="price" size="16" type="number" name="price_false" placeholder="Price false of product" value="{{ $model->price_false }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="controls">
                                <input class="form-control" id="price" size="16" type="text" name="weight" placeholder="Weight of product" value="{{ $model->weight }}" required>
                            </div>
                        </div>
                    </div>
                </div>
