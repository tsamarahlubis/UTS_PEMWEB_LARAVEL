...
<section class="section">
    ...
    <div class="card">
        <div class="card-body">
            ...
            @endforeach
            @endif
            <form class="form-horizontal" action="{{ route('admin.product.categories.store') }}" method="post">
                {{ csrf_field() }}
                ...
                <div class="form-actions">
                    <a href="{{ route('admin.product.categories.index') }}" tabindex="-1" class="btn btn-secondary">
